...
<!-- bootstrap-css -->
<link href="assets/css/front/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<!--// bootstrap-css -->
<!-- css -->
			...
			<div class="w3ls_banner_bottom_grids">
				<div class="col-md-4 agileits_services_grid" data-aos="fade-right">
					<div class="w3_agile_services_grid1">
						<img src="assets/frontimages/g1.jpg" alt=" " class="img-responsive">
				...
				<div class="col-md-4 agileits_services_grid" data-aos="fade-up">
					<div class="w3_agile_services_grid1">
						<img src="assets/frontimages/g2.jpg" alt=" " class="img-responsive">
						<div class="w3_blur"></div>
					</div>
					<h3>EVENT PLANNER</h3>
					<p>Enjoy the event throughout the entire night and do not sleep till the morning easy.</p>
				...
				<div class="col-md-4 agileits_services_grid" data-aos="fade-left">
					<div class="w3_agile_services_grid1">
						<img src="assets/frontimages/g3.jpg" alt=" " class="img-responsive">
						<div class="w3_blur"></div>
					</div>
					<h3>JOURNEY TRIP</h3>
					<p>Enjoy the event throughout the entire night and do not sleep till the morning easy.</p>
				...
				<div class="gallery-grids">
					<div class="tab_img">
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="assets/frontimages/g1.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="assets/frontimages/g1.jpg" class="img-responsive" alt="w3ls" />
								<div class="b-wrapper">
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="assets/frontimages/g3.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="assets/frontimages/g3.jpg" class="img-responsive" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="assets/frontimages/g4.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="assets/frontimages/g4.jpg" class="img-responsive" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="assets/frontimages/g5.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="assets/frontimages/g5.jpg" class="img-responsive" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="assets/frontimages/g6.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="assets/frontimages/g6.jpg" class="img-responsive" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="assets/frontimages/g7.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="assets/frontimages/g7.jpg" class="img-responsive" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="assets/frontimages/g8.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="assets/frontimages/g8.jpg" class="img-responsive" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="assets/frontimages/g2.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="assets/frontimages/g2.jpg" class="img-responsive" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
							...
							<ul class="slides">
								<li>
									<div class="item g1">
										...
										<img class="lazyOwl" src="assets/frontimages/manish.png" alt="" />
								...
								<li>
									<div class="item g1">
										<div class="agile-dish-caption">
										<img class="lazyOwl" src="assets/frontimages/anjaney.png" alt="" />
								...
								<li>
									<div class="item g1">
										<div class="agile-dish-caption">
										<img class="lazyOwl" src="assets/frontimages/shashi.jpg" alt="" />
											<h4>Shashi Sharma</h4>
	...
	<div class="pricing" id="pricing">
		<div class="container">
			...
			<div class="w3ls_banner_bottom_grids">
				<div class="col-md-4 agileits_services_grid" data-aos="fade-right">
					<div class="w3_agile_services_grid1">
						<img src="assets/frontimages/qutub_minar.jpg" alt=" " class="img-responsive">
						<div class="w3_blur"></div>
					</div>
					<div class="pr-ta">
						<h3>Qutub Minar</h3>
						<p class="text-justify">Qutab Minar is a soaring, 73 m-high tower of victory, built in 1193 by Qutab-ud-din Aibak immediately after the defeat of Delhi's last Hindu kingdom. <br><br></p>
				...
				<div class="col-md-4 agileits_services_grid" data-aos="fade-up">
					<div class="w3_agile_services_grid1">
						<img src="assets/frontimages/red_fort.jpg" alt=" " class="img-responsive">
						<div class="w3_blur"></div>
					</div>
					<div class="pr-ta">
						<h3>Red Fort</h3>
						<p class="text-justify">The Red sandstone walls of the massive Red Fort rise 33-m above the clamour of Old Delhi as a reminder of the magnificent power and pomp of the Mughal emperors.</p><br>
						<!-- <span class="moto-color1_3"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>&nbsp; December 28, 2017</span> -->
						<div class="tabl-erat">
							<div class="col-md-7 ratt">
								<h6>&#x20b9; 49,999/-per day</h6>
				...
				<div class="col-md-4 agileits_services_grid" data-aos="fade-left">
					<div class="w3_agile_services_grid1">
						<img src="assets/frontimages/india_gate.jpg" alt=" " class="img-responsive">
						<div class="w3_blur"></div>
					</div>
					<div class="pr-ta">
						<h3>India Gate</h3>
						<p class="text-justify">At the centre of New Delhi stands the 42 m high India Gate, an "Arc-de-Triomphe" like archway in the middle of a crossroad. <br><br></p> 
						<!-- <span class="moto-color1_3"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>&nbsp; December 28, 2017</span> -->
						<div class="tabl-erat">
							<div class="col-md-7 ratt">
								<h6>&#x20b9; 49,999/-per day</h6>
...
<!-- Stats -->
	<div class="stats news-w3layouts jarallax">
		<div class="container">
			...
			<script type="text/javascript" src="assets/js/front/numscroller-1.0.js"></script>
			<!-- //Progressive-Effects-Animation-JavaScript -->
		</div>
	</div>
	<!-- //Stats -->
                                ...
                                <div role="tabpanel" class="tab-pane active" id="testi">
                                    <div class="eventmain-info">
                                        <div class="event-subinfo">
                                            <div class="col-md-6  w3-latest-grid">
                                                <div class="col-md-6 col-xs-6 event-right eventtxt-right" data-aos="fade-down">
                                                   <img src="assets/frontimages/fan_dwarkasector14.jpg" class="img-responsive" alt="">
                                                </div>
                                            ...
                                            <div class="col-md-6 w3-latest-grid">
                                                <div class="col-md-6 col-xs-6 event-right" data-aos="fade-up">
                                                    <img src="assets/frontimages/sultan_jama-masjid.jpg" class="img-responsive" alt="">
                                                </div>
                                        ...
                                        <div class="event-subinfo">
                                            <div class="col-md-6 w3-latest-grid">
                                                <div class="col-md-6 col-xs-6 event-right  eventtxt-right" data-aos="fade-down">
                                                   <img src="assets/frontimages/pink_delhi_streets.jpg" class="img-responsive" alt="">
                                                </div>
                                            ...
                                            <div class="col-md-6 w3-latest-grid">
                                                <div class="col-md-6 col-xs-6 event-right" data-aos="fade-up">
                                                  <img src="assets/frontimages/dangal_talkatora.jpg" class="img-responsive" alt="">
                                                </div>
                                                <div class="col-md-6 col-xs-6 event-left in-news" data-aos="fade-right">
                                                     <h5>Dangal</h5>
                                ...
                                <div role="tabpanel" class="tab-pane" id="profile">
                                    <div class="eventmain-info">
                                        <div class="event-subinfo">
                                            <div class="col-md-6 w3-latest-grid">
                                                <div class="col-md-6 col-xs-6 event-right eventtxt-right">
                                                   <img src="assets/frontimages/ok_jaanu_jama_masjid.jpg" class="img-responsive" alt="">
                                                </div>
                                            ...
                                            <div class="col-md-6 w3-latest-grid">
                                                <div class="col-md-6 col-xs-6 event-right">
                                                    <img src="assets/frontimages/hindi_medium_chandni_chowk.jpg" class="img-responsive" alt="">
                                                </div>
                                        ...
                                        <div class="event-subinfo">
                                            <div class="col-md-6 w3-latest-grid">
                                                <div class="col-md-6 col-xs-6 event-right  eventtxt-right">
                                                    <img src="assets/frontimages/shab_delhi_NCR_indiaGate.jpg" class="img-responsive" alt="">
                                                </div>
                                                <div class="col-md-6 col-xs-6 event-left">
                                                    <h5>Shab</h5>
                                            ...
                                            <div class="col-md-6 w3-latest-grid">
                                                <div class="col-md-6 col-xs-6 event-right">
                                                   <img src="assets/frontimages/fukrey_returns_delhi_university.jpg" class="img-responsive" alt="">
                                                </div>
                                                <div class="col-md-6 col-xs-6 event-left in-news">
                                ...
                                <div role="tabpanel" class="tab-pane" id="messages">
                                    <div class="eventmain-info">
                                        <div class="event-subinfo">
                                            <div class="col-md-6 w3-latest-grid">
                                                <div class="col-md-6 col-xs-6 event-right eventtxt-right">
                                                    <img src="assets/frontimages/aiyaary_india_gate.jpg" class="img-responsive" alt="">
                                                </div>
                                                <div class="col-md-6 col-xs-6 event-left">
                                                    <h5>Aiyaary</h5>
                                            ...
                                            <div class="col-md-6 w3-latest-grid">
                                                <div class="col-md-6 col-xs-6 event-right">
                                                    <img src="assets/frontimages/baaghi2_paharganj.jpg" class="img-responsive" alt="">
                                                </div>
                                                <div class="col-md-6 col-xs-6 event-left in-news">
                                                    <h5>Baaghi 2</h5>
                                        ...
                                        <div class="event-subinfo">
                                            <div class="col-md-6 w3-latest-grid">
                                                <div class="col-md-6 col-xs-6 event-right  eventtxt-right">
                                                   <img src="assets/frontimages/october_delhi.jpg" class="img-responsive" alt="">
                                                </div>
                                                <div class="col-md-6 col-xs-6 event-left">
                                                    <h5>October</h5>
                                            ...
                                            <div class="col-md-6 w3-latest-grid">
                                                <div class="col-md-6 col-xs-6 event-right">
                                                   <img src="assets/frontimages/baazar_delhi.jpg" class="img-responsive" alt="">
                                                </div>
                                                <div class="col-md-6 col-xs-6 event-left in-news">
                                                    <h5>Baazaar</h5>
						...
						<div class="col-md-4 w3layouts_footer_grid" data-aos="fade-left">
							<h3>Fabulous Place in Delhi</h3>
							  <ul class="con_inner_text midimg">
								<li><a href="#" data-toggle="modal" data-target="#myModal"><img src="assets/frontimages/lodhi_gardens.jpg" alt="" class="img-responsive" /></a></li>
