	...
	<div class="pricing" id="pricing">
		<div class="container">
			...
			<div class="w3ls_banner_bottom_grids">
				<div class="col-md-4 agileits_services_grid" data-aos="fade-right">
					<div class="w3_agile_services_grid1">
						<img src="assets/frontimages/jama_masjid.jpg" alt=" "
							class="img-responsive">
						<div class="w3_blur"></div>
					</div>
					<div class="pr-ta">
						<h3>Jama Masjid</h3>
						<p class="text-justify">
							This great mosque of Old Delhi is the largest in India, with a
				...
				<div class="col-md-4 agileits_services_grid" data-aos="fade-up">
					<div class="w3_agile_services_grid1">
						<img src="assets/frontimages/lodhi_gardens.jpg" alt=" "
							class="img-responsive">
						<div class="w3_blur"></div>
					</div>
					<div class="pr-ta">
						<h3>Lodhi Gardens</h3>
						<p class="text-justify">The old Lady Willington Park, now
							known as Lodhi Garden, is dotted with monuments of Sayyid and
							Lodhi Periods, which include tombs mosques, and bridges .</p>
				...
				<div class="col-md-4 agileits_services_grid" data-aos="fade-left">
					<div class="w3_agile_services_grid1">
						<img src="assets/frontimages/rashtrapati_bhawan.jpg" alt=" "
							class="img-responsive">
						<div class="w3_blur"></div>
					</div>
					<div class="pr-ta">
						...
						<p class="text-justify">
							Rashtrapati Bhavan, home to the President of the world's largest
							democracy, is emblematic of Indian democracy and its secular,
							plural and inclusive traditions. 
						</p>
						<!-- <span class="moto-color1_3"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>&nbsp; December 28, 2017</span> -->
						<div class="tabl-erat">
							<div class="col-md-7 ratt">
			...
			<!-- <a href="moreLocations" class="scroll">More Locations</a> -->
		</div>
	</div>
