...
<section class="content">
	...
	<form:form action="updateManageApplicationDetails" method="POST"
		...
		<!-- #END# Basic Validation -->
			...
			<!-- Basic Validation -->
			<form:form action="changeApplicationStatus" method="POST" modelAttribute="locationPermission">
		<div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<div class="header">
					...
					<div class="body">
						<form:hidden path="id"/>
						<form:hidden path="agency.id"/>
						<form:hidden path="shootApplication.id"/>
						<div class="row clearfix">
							...
							<div class="col-md-4">
								...
								<form:select class="form-control show-tick"
										path="status.id" required="true" items="${listOfStatus}" itemLabel="name" itemValue="id">
										<%-- <form:option value="">-- Select Status --</form:option>
										<c:forEach items="${listOfStatus}" var="dirl" varStatus="loop">
											<form:option value="${dirl}">${dirl.name}</form:option>
										</c:forEach> --%>
									</form:select>
							</div>
