   ...
   <div class="container" >
         <div class="row" >
           <div class="col-md-4" data-aos="fade-left">
                <form class="creathon_login"  id="background-of-login">
                ...
                <form class="creathon_login"  id="background-of-login">
                  ...
                  <hr>
                   ...
                   <div class="form-group col-md-4">
                    ...
                    <div class="form-group col-md-12" >
                      <input type="text" class="form-control" placeholder="Address" name="" value="">
                    </div>
                    <div class="form-group col-md-12" >
                      <input type="text" class="form-control" placeholder="Permanent Address" name="" value="">
                    </div>
                    <div class="form-group col-md-6" >
                      <input type="text" class="form-control" placeholder="Primary Mobile Number" name="" value="">
                    </div>
                    <div class="form-group col-md-6" >
                      <input type="text" class="form-control" placeholder="Secondary Mobile Number" name="" value="">
                    </div>
                    <div class="form-group col-md-4">
                    ...
                    <div class="form-group col-md-12">
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="4" placeholder="Something About You"></textarea>
                    </div>

                <div class="form-check col-md-12">
                <input type="checkbox" class="form-check-input" id="exampleCheck1">
                <label class="form-check-label" for="exampleCheck1">Agree with Terms & Condition</label> <br>
                </div>
                <div class="loginbutton" >
                  <a href="#" >Sign Up</a>
                </div>
	 ...
	 NJ, 08540</label></li>
	 			...
	 			<div class="col-md-4 w3layouts_footer_grid" data-aos="fade-left">
	 				<h3>Recent Events</h3>
	 					...
	 					<li><a href="#" data-toggle="modal" data-target="#myModal"><img src="delhiAssets/images/g2.jpg" alt="" class="img-responsive" /></a></li>
