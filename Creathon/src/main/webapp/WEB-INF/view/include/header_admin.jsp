		...
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="javascript:void(0);" class="navbar-toggle collapsed"
					...
					href="<%=request.getContextPath()%>/adminDashboard">SIH ADMIN</a>
			</div>
			<div class="collapse navbar-collapse" id="navbar-collapse">
				<ul class="nav navbar-nav navbar-right">
				<ul class="nav navbar-nav link-effect-4">
								<li class="active first-list"><a href="<%=request.getContextPath()%>/">Home</a></li>
								<li><a href="<%=request.getContextPath()%>/adminDashboard" class="scroll">Dashboard</a></li>
								...
								<li><a href="producersComplaint" class="scroll">Producers Complaints</a></li>
								<li><a href="notAnsweredApplication" class="scroll">Not Answered Applications</a></li>
